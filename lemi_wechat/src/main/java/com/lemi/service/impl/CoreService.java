...
//                    	WeixinUserInfoServiceImpl weixinUserInfoServiceImpl = new WeixinUserInfoServiceImpl();
//                    	WeixinUserInfo userSelectById = weixinUserInfoServiceImpl.selectById(openid);
//	                	 if(userSelectById == null){
//	                		 userInfo.setOpenid(openid);
//	                		 weixinUserInfoServiceImpl.insert(userInfo);
//	                     } else{
//	                    	 weixinUserInfoServiceImpl.update(userInfo);
//	                     }
                    }
                }
                // 取消关注
